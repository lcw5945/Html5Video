...
flex.module('plugin.vr720').requires('config').define(function () {
    var _camera, _scene, _renderer, _mesh, config = null;
    var _texture;
    ...
    flex.Class.VR720 = class {
        ...
        init(){
            ...
            //如果媒体为空
            if(!flex.iplayer && !flex.iplayer.media){ return null; }
            //如果已初始化
            if(this.initfinish){ return null; }
            //移除媒体
            ...
            let playerOverLayer = flex.newElement('div');
