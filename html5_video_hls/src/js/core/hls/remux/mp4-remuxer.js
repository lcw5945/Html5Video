...
class MP4Remuxer {
  ...
  remux(audioTrack,videoTrack,id3Track,textTrack,timeOffset, contiguous) {
    ...
    this._e.fire(HLSEvent.SEG_PARSED);
  }
  ...
  generateIS(audioTrack,videoTrack,timeOffset) {
    ...
    if(Object.keys(tracks).length) {
      this._e.fire(HLSEvent.SEG_PARSING_INIT_SEGMENT,data);
      ...
      this._e.fire(HLSEvent.ERROR, {type : ErrorTypes.MEDIA_ERROR, details: ErrorDetails.FRAG_PARSING_ERROR, fatal: false, reason: 'no audio/video samples found'});
    }
  }
  ...
  remuxVideo(track, timeOffset, contiguous) {
   ...
   let nextAvcDts;
    ...
    track.samples = [];
    this._e.fire(HLSEvent.SEG_PARSING_DATA, {
      data1: moof,
      data2: mdat,
  ...
  remuxID3(track,timeOffset) {
    ...
    if(length) {
      ...
      this._e.fire(HLSEvent.SEG_PARSING_METADATA, {
  ...
  remuxText(track,timeOffset) {
    ...
    if(length) {
      ...
      this._e.fire(HLSEvent.SEG_PARSING_USERDATA, {
        samples:track.samples
      });
    }
